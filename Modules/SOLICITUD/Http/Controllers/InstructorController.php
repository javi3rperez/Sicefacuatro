...
{
    /**
     * Muestra el inventario para el instructor.
     */
    ...
    /**
     * Muestra el formulario para crear una nueva solicitud como instructor.
     */
    ...
    /**
     * Muestra el historial de solicitudes del instructor autenticado.
     */
    public function history_instructor()
    {
        ...
        $estado = request('estado'); // Filtro opcional por estado

        // Consulta las solicitudes del usuario
        $query = Solicitud::with('items')
    ...
    /**
     * Almacena una nueva solicitud realizada por el instructor.
     */
    public function store_instructor(Request $request)
    {
        ...
        return redirect()
            ->route('solicitud.instructor.history')
            ->with('success', 'Solicitud enviada correctamente');
    }

    /**
     * Elimina una solicitud específica realizada por el instructor.
     */
    public function destroy_instructor($id)
    {
        ...
        return redirect()->route('solicitud.instructor.history')
            ->with('success', 'Solicitud eliminada correctamente');
    }
    
    /**
     * Muestra los movimientos asociados a las solicitudes del instructor autenticado.
     */
