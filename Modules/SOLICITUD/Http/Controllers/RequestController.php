...
class RequestController extends Controller
{
    ...
    public function request_leader()
    {
     ...
     /**
     * Muestra el historial de solicitudes del líder
     */
    ...
    public function store_leader(Request $request)
    {
        ...
        return redirect()->route('solicitud.leader.history')->with('success', 'Solicitud enviada correctamente');
    }
    ...
    public function destroy_leader($id)
    {
        ...
        return redirect()->route('solicitud.leader.history')->with('success', 'Solicitud eliminada correctamente');
    }

    public function movements_leader()
    {
        $user = auth()->user();
        ...
        return view('solicitud::leader.movements', compact('movimientos'));
    }
}
