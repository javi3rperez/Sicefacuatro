    ...
    <div class="card border-0 shadow-lg rounded-lg overflow-hidden">
        <div class="card-header bg-white py-3 border-0">
            <h5 class="mb-0 text-secondary font-weight-bold">
                <i class="fas fa-list-alt mr-2 text-success"></i>Listado de Categorías
            </h5>
        </div>
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr class="border-bottom">
                            <td class="align-middle font-weight-bold text-dark">{{ $category['id'] }}</td>
                            ...
                            <td class="align-middle text-center">
                                <div class="d-flex justify-content-center">
                                    ...
                                    <form action="" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-sm btn-icon btn-soft-danger rounded-circle shadow-sm" onclick="return confirm('¿Estás seguro de eliminar esta categoría?')" title="Eliminar">
        ...
        <div class="card-footer bg-white py-3 border-0">
            <div class="d-flex justify-content-between align-items-center">
                <div class="text-muted small">
                    Mostrando {{ count($categories) }} registros
                </div>
